...
//
//        val moved =
//            Board(prevCellArr) //getting a copy of the board and making the current move in the copy
//        scores[i] = getScore(moved, depth, false, alpha, beta, color)  //false -- isKingMove
...
//    var beta = beta
//    val moves: List<Move> = board.generateAllMoves(color)
//    if (depth == 0) return if (maxing) getScore(board, "RED") else -getScore(board, "BLACK")
//    if (color == "RED") depth++
...
//}
//
//fun getScore(board: Board, color: String) : Float {
//    if(color == "RED") {
